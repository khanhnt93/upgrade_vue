      ...
      <div class="w-full px-2">
        <div class="card">
          <div class="card-body p-4">
            ...
            <div class="flex flex-wrap -mx-2 form-row" v-show="product.product_id">
              <div class="w-full md:w-1/4 px-2 mt-2">
                <label> Thêm hình ảnh </label>
              </div>
              <div class="w-full md:w-3/4 px-2 mt-2">
                <div class="flex">
                  <input type="text" v-model="image" class="form-control flex-1" readonly>
            ...
            <div class="flex flex-wrap -mx-2 mt-2 text-center" v-show="this.image_preview">
              <div class="w-full px-2">
                <button class="btn btn-outline-success text-center btn-width-160" @click="prepareUpload" :disabled="saving">
                  Upload hình
                </button>
              </div>
            </div>

            <div class="flex flex-wrap -mx-2 form-row" v-show="image">
...
<!--            Chỗ này show list image review-->
            ...
            <div class="flex flex-wrap -mx-2">
              <div class="w-full md:w-1/4 px-2" v-for="(item, index) in images" :key="item.image_url">
                ...
                <div class="text-center mt-2">
                  <button class="btn btn-outline-danger btn-width-120"  v-show="!loadingDelete"
