        ...
        <div class="row">
          <div class="col-lg-6 mt-3">
            ...
            >
              ...
              <p class="text">
                ciSale được thiết kế phù hợp với mọi loại hình kinh doanh: từ công ty đến các cá nhân nhỏ lẻ.
              </p>
        ...
        <div class="row">
          <div class="col-lg-6 order-lg-last mt-3">
            <div class="about-content mt-50 fadeInLeftBig">
              <div class="section-title">
                <h3 class="title">
                    Tại sao <span>ciSale là lựa chọn của bạn?</span>
                  </h3>
              </div>
              <p class="text">
                Áp dụng công nghệ tiên tiến trong phát triển hệ thống, ciSale sẽ đem lại cho bạn những trải nghiệm
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-8">
              ...
              >
                ...
                <p class="text">
                  ciSale - Giải pháp chọn vẹn cho quản lý bán hàng và tài chính
                </p>
                <ul class="social">
                  <li>
