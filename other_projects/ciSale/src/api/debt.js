...
export default {
  ...
  /**
   * Get public debt by customer
   */
  getPublicDebtByCustomer(customerId) {
    return session.get(RootAPI + 'public-debt/get-by-customer/' + customerId)
  },
   ...
   * Get debt history
   */
  getDebtHistory(params) {
    return session.post(RootAPI + 'debt/search-his', params)
  },

    /**
   * Get public debt history
   */
  getPublicDebtHistory(params) {
    return session.post(RootAPI + 'public-debt/search-his', params)
  },
}
