<template>
  <div class="container-fluid">
    <b-row>
      <b-col>
        <b-card>
          ...
          <b-row>
            <b-col md='12'>
              <h4 class="mt-2 text-center text-header">Danh Sách Nhân Viên</h4>
            </b-col>
          </b-row>
          <hr>
    ...
    <b-modal centered hide-footer hide-header id="modal-confirm-reset-pass">
      ...
      <b-row>
        <b-col class="text-center mt-3" v-show="!reseting">
        ...
        <b-col v-show="reseting">
          <span class="loading-more" v-show="reseting"><icon name="loading" width="60" /></span>
        </b-col>
      </b-row>
    </b-modal>
