        ...
        <b-card>
          <b-card-body class="p-4">
            ...
            <b-row>
              ...
              <b-col md="3">
                <h5 class="border-top">
                  <b-button variant="outline-primary" class="pull-right btn-width-160 mt-2 mb-2" @click="plusFundMoney">
                    Thêm vốn đầu ngày
                  </b-button>
                </h5>
              ...
              <b-col md="3">
                <h5 class="border-top">
                  <b-button variant="outline-primary" class="pull-right btn-width-160 mt-2 mb-2" @click="plusMoney">
                    Thêm tiền thu
                  </b-button>
                </h5>
              </b-col>
              <b-col md="3">
                <h5 class="border-top">
                  <b-button variant="outline-primary" class="pull-right btn-width-160 mt-2 mb-2" @click="minusMoney">
                    Thêm tiền chi
                  </b-button>
                </h5>
              </b-col>
    ...
    <b-modal :title="modalTitle" centered hide-footer id="modal-change-money">
      ...
      <b-row>
        <b-col cols="4" class="text-left mt-3">
          <b-button variant="outline-danger" class="pull-left btn-width-120" @click="cancelChangeMoney()">
            Hủy
          </b-button>
        </b-col>
        <b-col cols="8" class="text-right mt-3">
          <b-button variant="outline-success" class="pull-right btn-width-120" @click="confirmChangeMoney" :disabled="saving">
            Xác nhận
          </b-button>
        </b-col>
      </b-row>
