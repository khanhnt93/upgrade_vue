      ...
      <b-col>
        <b-card>
          <b-card-body class="p-4">
              ...
              <b-row class="form-row">
                <b-col md="3" class="mt-2">
                  <label> Gói sử dụng </label><span class="error-sybol"></span>
                </b-col>
                <b-col md="9">
                  <b-form-select
                  ...
                  ></b-form-select>
                  <b-form-invalid-feedback  class="invalid-feedback" :state="!errorPackage">
                    Vui lòng chọn gói sử dụng
                  </b-form-invalid-feedback>
                </b-col>
              </b-row>
...
export default {
  ...
  computed: {
    ...
    errorPackage: function () {
      return this.checkInfo(this.store.package)
    },
  ...
  methods: {
    checkInfo (info) {
      return (this.clicked && (info == null || info.length <= 0))
    },
    checkValidate () {
      return !(this.errorName || this.errorCiti || this.errorDistrict || this.errorAddress || this.errorPhoneNumber
          || this.errorPackage || this.errorExpiredAt)
    },
        ...
        superAdminAPI.getStoreDetail(storeId).then(res => {
          if(res != null && res.data != null && res.data.data != null) {
            // this.store = Mapper.mapStoreDetailModelToDto(res.data.data)
              ...
              this.store.expired_at = commonFunc.formatDate(this.store.expired_at)
            this.getTimeLive()
            this.getOptionCity()
          }
        }).catch(err => {
