        ...
        <div class="p-6">
          ...
          <div class="mt-6">
            <button
              ...
              @click="exportToExcel(bills, excel_bill_fields.value, 'store_bill_report', 'Bill Report')">
              Xuất Excel
            </button>
            <button
              v-if="!firstSearch && !loading && inputs.reportBy == 'food'"
              class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              @click="exportToExcel(foods, excel_food_fields.value, 'store_food_report', 'Food Report')">
              Xuất Excel
            </button>
