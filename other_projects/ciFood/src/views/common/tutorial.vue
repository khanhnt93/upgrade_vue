                ...
                <div class="w-full">
                  ...
                  <div v-show="isShowBaseSetting" class="mt-4">
                    <div class="w-full">
                      ...
                      <p class="lv2">4. Thêm nhóm quyền</p>
                      <p class="lv2">5. Thêm nhân viên</p>
                      <p>
                    ...
                    <div class="w-full">
                      ...
                      <div v-show="isShowOptionTopping" class="lv3 mt-2">
                        <div class="w-full">
                          ...
                          <p class="lv3"><b>1. Thêm lựa chọn</b></p>
                          <p class="lv3">- Để thêm lựa chọn cho món, bạn vào menu “Thiết lập cửa hàng”, chọn “Thực đơn”</p>
                          <p class="lv3">- Trong màn hình khai báo mới hoặc cập nhập thực đơn, tại mục “Lựa chọn”, bấm dấu “+”.
                            Popup “Thêm lựa chọn” sẽ hiện lên, bạn điền vào các mục và bấm “Thêm”. Sau khi đã thêm đủ thì bấm “Xác nhận”.
                          </p>
                          <p>
                            <img src="/static/img/project/guide/option.PNG" class="image-guide"/>
                          </p>

                          <p class="lv3 pt-3"><b>2. Thêm topping</b></p>
                          <p class="lv3">- Bước 1: Thêm topping</p>
                          <p class="lv4">- Để thêm topping, bạn vào menu “Thiết lập cửa hàng”, chọn “Topping”</p>
                          <p class="lv4">- Thêm mới đầy đủ topping có dùng trong nhà hàng</p>
                          <p class="lv3">- Bước 2: Set topping cho món</p>
                          <p class="lv4">- Để set topping cho món, bạn vào menu “Thiết lập cửa hàng”, chọn “Thực đơn”</p>
                          <p class="lv4">- Trong màn hình khai báo mới hoặc cập nhập thực đơn, tại mục “Topping”, bấm dấu “+”.
                            Popup “Chọn topping” sẽ hiện lên, Bạn chọn những topping có dùng cho món này. Sau khi đã chọn đủ thì bấm “Xác nhận”.
                          </p>
                          <p>
                      ...
                      <div v-show="isShowPromotion" class="lv3">
                        <div>
                          ...
                          <p class="lv4">- Discount With Max Value: Giảm giá theo % khi đạt mức tối thiểu và giới hạn số tiền giảm.
                            Ví dụ: Giảm giá 30% cho hóa đơn từ 100k, tối đa 30k
                          </p>
                          <p class="lv4">- Voucher: Số tiền tương ứng tiền mặt. Ví dụ: Voucher 200k</p>
                          <p class="lv4">- Free item: Miễn phí món. Ví dụ: miễn phí coca, pepsi, hay trà đá.</p>

                          <p class="pt-2">Thiết lập để khuyến mãi tự động áp dụng theo khung giờ</p>
                          <p class="lv4">- Tại mục “Khung giờ tự động áp dụng”, bạn chọn “Có”.
                            Sau đó chọn những ngày và giờ bạn muốn khuyến mãi tự động được áp dụng
                          </p>
                      ...
                      <div v-show="isShowPrinterArea" class="lv3">
                        <div>
                          ...
                          <p>Để món ăn được in đúng khu vực chế biến, bạn cần làm các bước sau:</p>
                          <p class="lv3">- Bước 1: Thêm khu vực chế biến</p>
                          <p class="lv4">- Để thêm khu vực chế biến, bạn vào menu “Thiết lập cửa hàng”, chọn “Khu vực chế biến”</p>
                          <p class="lv4">- Thêm mới các khu vực chế biến trong nhà hàng</p>
                          <p>
                            <img src="/static/img/project/guide/kitchen_area.PNG" class="image-guide"/>
                          </p>
                          <p class="lv3">- Bước 2: Set khu vực chế biến cho món</p>
                          <p class="lv4">- Để set khu vực chế biến cho món, bạn vào menu “Thiết lập cửa hàng”, chọn “Thực đơn”</p>
                          <p class="lv4">- Trong màn hình khai báo mới hoặc cập nhập thực đơn, tại mục “Khu vực in”,
                            bạn chọn khu vực muốn chế biến món
                          </p>
                          <p>
                      ...
                      <div v-show="isShowRepository" class="lv3">
                        <div>
                          ...
                          <p class="lv4">- Để thêm đơn vị, bạn vào menu “Quản lý kho hàng”, chọn “Đơn vị”</p>
                          <p class="lv4">- Thêm mới các đơn vị cần thiết trong nhà hàng. Ví dụ: gram, ml, lit, cái, chai, lon,...</p>
                          <p>
                            <img src="/static/img/project/guide/unit.PNG" class="image-guide"/>
                          </p>
                          <p class="lv3">- Bước 2: Thêm nguyên liệu, mặt hàng</p>
                          <p class="lv4">- Để thêm nguyên liệu, mặt hàng, bạn vào menu “Quản lý kho hàng”, chọn “Nguyên liệu, mặt hàng”</p>
                          <p class="lv4">- Thêm mới các nguyên liệu, mặt hàng trong kho. Ví dụ: cafe bột, sữa tươi, coca, ...
                          </p>
                          <p>
                            <img src="/static/img/project/guide/resource.PNG" class="image-guide"/>
                          </p>
                          <p class="lv3">- Bước 3: Set nguyên liệu cho món</p>
                          <p class="lv4">- Để set nguyên liệu cho món, bạn vào menu “Thiết lập cửa hàng”, chọn “Thực đơn”</p>
                          <p class="lv4">
                            - Trong màn hình khai báo mới hoặc cập nhập thực đơn, tại mục “Nguyên liệu”, bạn click dấu "+".
                            Trên popup "Chọn nguyên liệu", bạn chọn nguyên liệu, nhập số lượng, sau đó nhấn "Thêm". Sau khi thêm đủ, nhấn "Xác nhận"
                          </p>
                          <p>
                            <img src="/static/img/project/guide/chose_resource.PNG" class="image-guide"/>
                          </p>
                      ...
                      <div v-show="isShowStoreSetting" class="lv3">
                        <div>
                          ...
                          <p>- Trong màn hình "Cài đặt", bạn chọn cho phù hợp rồi nhấn "Lưu" nhé</p>
                          <p>
                    ...
                    <div>
                            ...
                            <div>
                              ...
                              <div v-show="isShowGuideOrderByWindowns" class="lv4">
                                ...
                                <div>
                                  ...
                                  <p class="pl-2">3. Để order món nào, bạn hãy click vào dấu "+" tại món đó (khung số 3)</p>
                                  <p class="pl-2">4. Sửa giá của món đang order (khung số 4)</p>
                                  <p class="pl-2">5. Sửa số lượng của món đang order (khung số 5)</p>
                                  <p class="pl-2">6. Thêm ghi chú trên món</p>
                            ...
                            <div>
                              ...
                              <div v-show="isShowGuidePaymentByMobile" class="lv4">
                                ...
                                <div>
                                  ...
                                  <p class="pl-2">3. Thêm phí dịch vụ, phụ thu</p>
                                  <p class="pl-2">4. Nhập loại tiền khách trả (giúp thống kê két tiền)</p>
                                  <p class="pl-2">5. Tính tiền thừa trả khách</p>
                                  <p class="pl-2">6. Sửa giá món</p>
                                  <p class="pl-2">7. Sửa số lượng món đã order</p>
                      ...
                      <div v-show="isShowGuideManRepository" class="lv3">
                        <div>
                          ...
                          <p class="ml-2">Bước 3: Tại màn hình "Đơn vị", click "Thêm", thêm lần lượt tất cả các đơn vị
                            quán bạn có sử dụng. Ví dụ: ml, lít, kg, gram, chai, lon, cái, ...</p>
                          <p class="ml-2">Bước 4: Tại menu "Quản lý kho hàng", chọn "Nguyên liệu - Mặt hàng"</p>
                          <p class="ml-2">Bước 5: Tại màn hình "Nguyên liệu - Mặt hàng", click "Thêm", thêm lần lượt
                            tất cả các nguyên liệu có sử dụng trong quán của bạn. Ví dụ: cafe bột, sữa tươi, nước suối,
                          cánh gà, ...</p>
                          <p class="ml-2">Bước 6: Tại menu "Thiết lập", chọn "Thực đơn"</p>
                          <p class="ml-2">Bước 7: Tại màn hình "Danh sách thực đơn", click icon "Edit" tại món bạn muốn
                            set nguyên liệu</p>
                          <p class="ml-2">Bước 8: Tại màn hình "Thực đơn", click dấu "+" ở mục nguyên liệu, chọn "Nguyên
                            ...
                            <div>
                              ...
                              <div v-show="isShowGuideManMoneyBoxByWeb" class="lv4">
                                <div>
                                  ...
                                  Thêm tiền thu (ví dụ: tiền bo cho quán), thêm tiền chi (ví dụ: tiền điện nước, tiền
                      ...
                      <div v-show="isShowGuideReport" class="lv3">
                        <div>
                          ...
                          <p class="ml-2">"Báo cáo theo ngày": Cho phép bạn thống kê nhanh chóng "Số lượng hoá đơn",
                          "Tổng doanh thu", "Tổng chi phí", "Tổng lợi nhuận", "Tiền vốn đầu ngày".</p>
                          <p class="ml-2">"Biểu đồ doanh thu": Cho phép bạn có cái nhìn tổng quan doanh thu theo thời gian.</p>
                          <p class="ml-2">"Báo cáo bán hàng": Cho phép bạn tìm kiếm, xem lại danh sách hóa đơn của quán.</p>
                          <p class="ml-2">"Thống kê": Thống kê món theo số lượng và doanh thu. Giúp bạn dễ dàng tìm ra
                          những món đem lại doanh thu cao, giúp cho các chiến lược marketing của bạn thêm hiệu quả.</p>
                          <p class="ml-2">"Báo cáo lợi nhuận": Cho phép bạn thống kê lợi nhuận theo thời gian.</p>
                          <p class="ml-2">"Báo cáo theo nhân viên": Cho phép chủ quán vi vu đi du lịch vẫn nắm mọi hoạt
                          động của nhân viên.</p>
                          <p class="ml-2">"Báo cáo khuyến mãi": Cho phép bạn thống kê các khuyến mãi đã dùng.</p>
                          <p class="ml-2">"Báo cáo xóa bill": Cho phép bạn thống kê các bill đã xóa, tránh gian lận nhưng
                           linh hoạt sử dụng.</p>
                          <p class="ml-2">"Báo cáo sửa bill cũ": Cho phép bạn thống kê việc sửa bill cũ, tránh gian lận nhưng
...
export default {
  ...
  data () {
    return {
      ...
      isShowGuideOrder: false,
      isShowGuideOrderByMobile: false,
      isShowGuideOrderByWindowns: false,
      isShowGuideOrderByPOSAndroid: false,
      isShowGuidePayment: false,
      isShowGuidePaymentByMobile: false,
      isShowGuidePaymentByWindowns: false,
      isShowGuideChangeTable: false,
      isShowGuideChangeTableByMobile: false,
      isShowGuideChangeTableByWindowns: false,
      isShowGuideMergeTable: false,
      isShowGuideMergeTableByMobile: false,
      isShowGuideMergeTableByWindowns: false,
      isShowGuideCancelFood: false,
      isShowGuideCancelFoodByMobile: false,
      isShowGuideCancelFoodByWindowns: false,
      isShowGuideCancelOrder: false,
      isShowGuideCancelOrderByMobile: false,
      isShowGuideCancelOrderByWindowns: false,
      isShowGuideCleanTable: false,
      isShowGuideCleanTableByMobile: false,
      isShowGuideCleanTableByWindowns: false,
      isShowGuideManOrder: false,
      isShowGuideManOrderByMobile: false,
      isShowGuideManOrderByWindowns: false,
      isShowGuideOrderHistory: false,
      isShowGuideOrderHistoryByMobile: false,
      isShowGuideOrderHistoryByWindowns: false,
      isShowGuideBillHistory: false,
      isShowGuideBillHistoryByMobile: false,
      isShowGuideBillHistoryByWindowns: false,
      isShowGuidePrintOldBill: false,
      isShowGuidePrintOldBillByMobile: false,
      isShowGuidePrintOldBillByWindowns: false,
      isShowGuideDeleteBill: false,
      isShowGuideDeleteBillByMobile: false,
      isShowGuideDeleteBillByWindowns: false,
      isShowGuideManRepository: false,
      isShowGuideManMoneyBox: false,
      isShowGuideManMoneyBoxByWeb: false,
      isShowGuideManMoneyBoxByWindowns: false,
      isShowGuideChangeShift: false,
      isShowGuideChangeShiftByWeb: false,
      isShowGuideChangeShiftByWindowns: false,
      isShowGuideReport: false,
      isShowGuideManCustomer: false,
    }
  },
  mounted() {
  },
