        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="section-title text-center">
              ...
              <h3 class="title">
                ciFood
                <span> Giải Pháp Trọn Vẹn Cho Nhà Hàng, Quán Ăn</span>
              </h3>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-7 col-sm-8  mt-3">
            ...
            >
              ...
              <div class="services-content mt-30">
                ...
                <p class="text">
                  Chủ nhà hàng vi vu đi du lịch nhưng vẫn nắm hoàn toàn hoạt động của nhà hàng, hoạt động của từng nhân
                  viên.
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-7 col-sm-8  mt-3">
            ...
            >
              ...
              <div class="services-content mt-30">
                ...
                <p class="text">
                  Ngoài các tính năng căn bản của ngành F&B, ciFood còn tích hợp hệ thống CRM, chăm sóc khách hàng,
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mt-3">
            ...
            >
              <div class="section-title">
                <h3 class="title">Cấu trúc <span> phù hợp với mọi loại hình nhà hàng, quán ăn</span></h3>
              </div>
              <p class="text">
                ciFood được thiết kế phù hợp với mọi loại hình nhà hàng, quán ăn, quán nhậu, cafe, trà sữa.
              </p>
          ...
          <div class="col-lg-6 mt-3">
            ...
            >
              <img src="/static/img/project/home/loai_nha_hang.PNG" alt="Loại hình nhà hàng, quán ăn" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-6 order-lg-last  mt-3">
            ...
            >
              ...
              <p class="text">
                ...
                đáp ứng hoàn toàn nhu cầu của nhà hàng, quán ăn.
              </p>
              <button class="main-btn" @click="scrollBottom()">Liên hệ ngay</button>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            >
              <div class="section-title">
                <h3 class="title">
                  Tại sao <span>ciFood là lựa chọn của bạn?</span>
                </h3>
              </div>
              <p class="text">
                Áp dụng công nghệ tiên tiến trong phát triển hệ thống, ciFood sẽ đem lại cho bạn những trải nghiệm
          ...
          <div class="col-lg-6">
            <div
              class="about-image text-center mt-50 fadeInRightBig"
            >
              <img src="/static/img/project/home/best_choose.png" alt="Best choose" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-8">
              ...
              >
                ...
                <p class="text">
                  ciFood - Giải pháp trọn vẹn cho nhà hàng, quán ăn của bạn.
                </p>
                <ul class="social">
                  <li>
            ...
            <div class="col-lg-4 col-md-5 col-sm-5">
              ...
              >
                ...
                <ul class="contact">
                  ...
                  <li>Số điện thoại: 0969.675.819</li>
                  <li>Email: info@ciintech.com</li>
                  <li>Website: <a href="https://ciintech.com" target="_blank">https://ciintech.com</a></li>
