...
export default {
  ...
  /**
   * Get option related service
   */
  getOptionRelatedService () {
    return session.get(RootAPI + 'menu/get-option-related-service')
  },
  ...
  getOptionRelatedStaff() {
    return session.get(RootAPI + 'staff/get-option-related-staff')
  },
  ...
  /**
   * Staff send cancel service
   */
  sendCancelService(orderInfo) {
    return session.post(RootAPI + 'staff/send-cancel-service', orderInfo)
  },
   ...
   * Admin confirm cancel order
   */
  confirmCancelService(orderInfo) {
    return session.post(RootAPI + 'staff/confirm-cancel-service', orderInfo)
  },
  ...
  getCommissionReport(params) {
    return session.post(RootAPI + 'report/get-commission-report', params)
  },
  ...
  editCommissionReport(params) {
    return session.post(RootAPI + 'report/edit-commission-report', params)
  },
  ...
  getBrandCommissionReport(params) {
    return session.post(RootAPI + 'report/get-brand-commission-report', params)
  },
   ...
   * Get staff option
   */
  getStaffOptionByBrand (store_id) {
    return session.post(RootAPI + 'staff/staff-option-by-brand/' + store_id)
  },
   ...
   */
  getConfirmedSchedules(params){
    return session.post(RootAPI + 'appointment/get-confirmed-schedules', params)
  },
   ...
   */
  getStaff(params){
    return session.post(RootAPI + 'appointment/get-store-info', params)
  },
  ...
  searchAppointment(params){
    return session.post(RootAPI + 'appointment/search-appointment', params)
  },
  ...
  confirmAppointment(params){
    return session.post(RootAPI + 'appointment/confirm-appointment', params)
  },
  ...
  deleteAppointment(params){
    return session.post(RootAPI + 'appointment/delete-appointment', params)
  },
  ...
  updateAppointment(params){
    return session.post(RootAPI + 'appointment/update-appointment', params)
  },
   ...
   */
  getServices(params) {
    return session.post(RootAPI + "appointment/get-services",params)
  },

  /**
   * Get staff schedule for appointment
   */
  getSchedule(params) {
    return session.post(RootAPI + "appointment/get-schedules", params)
  },
  ...
  makeAppointment(params) {
    return session.post(RootAPI + "appointment/make-appointment-by-staff", params)
  },
