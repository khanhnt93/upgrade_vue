...
export default {
   ...
   * Update note
   */
  confirmUpdateNote(params) {
    return session.post(RootAPI + "customer/update-payment-note", params)
  },
   ...
   * Get customer detail by store
   */
  getCustomerHistoryDetail(id) {
    return session.post(RootAPI + "customer/history-detail/" + id)
  },
  ...
  getOptionRelatedCusHis() {
    return session.get(RootAPI + "customer/get-options-related-cus-his")
  },

  /**
   * Get danh sách dv đang sở hữu
   */
  getCustomerServiceOwner(params) {
    return session.post(RootAPI + "customer/get-customer-service", params)
  },
  ...
  /**
   * Get store info for appointment
   */
  getStoreInfo(params) {
  ...
  makeAppointment(params) {
    return session.post(RootAPI + "appointment/make-appointment", params)
  },
