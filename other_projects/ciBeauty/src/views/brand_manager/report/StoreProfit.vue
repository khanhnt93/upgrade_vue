        ...
        <div class="bg-white rounded-lg shadow-md p-4">
          <div class="card-body p-4"  >
            ...
            <div class="grid grid-cols-12 gap-4">
              ...
              <div class="col-span-3" v-show="inputs.dataBy != 'Month'">
              ...
              <div class="col-span-3" v-show="inputs.dataBy == 'Month'">
                ...
                <input
                  ...
                  @keyup="inputDateOnly($event.target)"
                  :disabled="onSearch">
                <div class="invalid-feedback invalid-feedback"   :state="!errorFromMonth">
              ...
              <div class="col-span-3" v-show="inputs.dataBy == 'Month'">
                ...
                <input
                  ...
                  @keyup="inputDateOnly($event.target)"
                  :disabled="onSearch">
                <div class="invalid-feedback invalid-feedback"   :state="!errorToMonth">
            ...
            <div class="grid grid-cols-12 gap-4" v-show="click && datas.length> 0">
                <div class="col-span-full">
