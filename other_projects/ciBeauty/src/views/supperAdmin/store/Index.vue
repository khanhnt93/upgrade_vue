          ...
          <div class="card-body p-4"  >
              ...
              <div class="grid grid-cols-12 gap-4 form-row">
                ...
                <div class="col-span-9">
                  ...
                  <div class="invalid-feedback invalid-feedback"   :state="!errorCiti">
              ...
              <div class="grid grid-cols-12 gap-4 form-row">
                ...
                <div class="col-span-9">
                  <select class="form-control form-control"
                    ...
                    ></select>
                  <div class="invalid-feedback invalid-feedback" :state="!errorDistrict">
                    Vui lòng nhập quận
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-12 gap-4 form-row">
                ...
                <div class="col-span-9">
                  ...
                  maxlength="20">
                  <div class="invalid-feedback invalid-feedback"   :state="!errorPhoneNumber">
              ...
              <div class="grid grid-cols-12 gap-4 form-row">
                <div class="col-span-3 mt-2">
                  <label>Mã số thuế</label><span class="error-sybol"></span>
                </div>
                <div class="col-span-9">
                  <input
                  id="tax_code"
              ...
              <div class="grid grid-cols-12 gap-4 form-row">
                ...
                <div class="col-span-9">
                  ...
                  <div class="invalid-feedback invalid-feedback"   :state="!errorExpiredAt">
              ...
              <div class="grid grid-cols-12 gap-4 mt-3">
                ...
                <div class="col-span-6">
                  <button class="btn pull-left px-4 default-btn-bg" :disabled="saving" @click="save" >
                      Lưu
                  </button>
                </div>
              </div>
