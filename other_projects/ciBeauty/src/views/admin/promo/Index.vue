          ...
          <div class="card-body p-4"  >
            ...
            <span class="loading-more" v-show="loading"><icon name="loading" width="60" /></span>
              ...
              <div class="grid grid-cols-12 gap-4 row form-row">
                ...
                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'discount' || promo.type == 'discount_with_max_value'
                || promo.type == 'discount_on_item' || promo.type == 'discount_on_group_item'">
                  ...
                  <div class="col-span-9">
                    ...
                    <div class="invalid-feedback invalid-feedback"   :state="!errorPercentDiscount">
                      Vui lòng nhập phần trăm giảm giá
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'discount_with_max_value'">
                  <div class="col-span-3 mt-2">
                  ...
                  <div class="col-span-9">
                    ...
                    maxlength="20"
                    @keyup="integerOnly($event.target)">
                    <div class="invalid-feedback invalid-feedback"   :state="!errorMaxDiscount">
                ...
                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'discount_with_max_value'">
                  ...
                  <div class="col-span-9">
                    ...
                    maxlength="20"
                    @keyup="integerOnly($event.target)">
                    <div class="invalid-feedback invalid-feedback"   :state="!errorDiscountOnAmount">
                      Vui lòng nhập trên tổng giá
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'voucher'">
                  <div class="col-span-3 mt-2">
                  ...
                  <div class="col-span-9">
                    ...
                    maxlength="20"
                    @keyup="integerOnly($event.target)">
                    <div class="invalid-feedback invalid-feedback"   :state="!errorValueOfVoucher">
                      Vui lòng nhập giá trị voucher
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'free_item'">
                  <div class="col-span-3 mt-2">
                  ...
                  <div class="col-span-9">
                    ...
                    v-model="promo.item_free">
                      <option v-for="option in itemFreeOptions" :key="option.value" :value="option.value">
                        {{ option.text }}
                      </option>
                    </select>
                    <div class="invalid-feedback invalid-feedback"   :state="!errorFreeItem">
                      Vui lòng nhập item free
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'discount_on_item'">
                  <div class="col-span-3 mt-2">
                    <label> Giảm giá trên dv </label><span class="error-sybol"></span>
                  </div>
                  <div class="col-span-9">
                    <div class="grid grid-cols-12 gap-4">
                      <div class="col-span-6" v-for="item in itemService" :key="item.value">
                        <input :id="item.value" type="checkbox" v-model="promo.on_items" name="discountOnItem" :value="item.value">
                        <label :for="item.value">{{ item.text }}</label>
                      </div>
                    </div>
                    <div class="invalid-feedback invalid-feedback"   :state="!errorDiscountOnItem">
                      Vui lòng chọn dv muốn giảm giá
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" v-if="promo.type == 'discount_on_group_item'">
                  <div class="col-span-3 mt-2">
                    <label> Giảm giá trên nhóm dv </label><span class="error-sybol"></span>
                  </div>
                  <div class="col-span-9">
                    <div class="grid grid-cols-12 gap-4">
                      <div class="col-span-6" v-for="item in itemGroupService" :key="item.id">
                        <input :id="item.id" type="checkbox" v-model="promo.on_group_items" name="discountOnGroupItem" :value="item.id">
                        <label :for="item.id">{{ item.name }}</label>
                      </div>
                    </div>
                    <div class="invalid-feedback invalid-feedback"   :state="!errorDiscountOnGroupItem">
                      Vui lòng chọn nhóm dv muốn giảm giá
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" v-show="promo.method == 'trade_point'">
                  <div class="col-span-3 mt-2">
                  ...
                  <div class="col-span-9">
                    ...
                    v-model="promo.cost"
                    @keyup="integerOnly($event.target)">
                    <div class="invalid-feedback invalid-feedback" :state="!errorCost">
                      Vui lòng nhập giá
                    </div>
                  </div>
                </div>

                <div class="grid grid-cols-12 gap-4 row form-row" horizontal>
                  <div class="col-span-3 mt-2">
                  ...
                  <div class="col-span-9">
                    ...
                    <div class="invalid-feedback invalid-feedback"   :state="!errorExpiredDateFrom">
                ...
                <div class="grid grid-cols-12 gap-4 row form-row" horizontal>
                  ...
                  <div class="col-span-9">
                    ...
                    <div class="invalid-feedback invalid-feedback"   :state="!errorExpiredDateTo">
                ...
                <div class="grid grid-cols-12 gap-4" v-show="promo.method == 'other'">
                  <div class="col-span-full">
                    <div class="grid grid-cols-12 gap-4 row form-row">
                      <div class="col-span-3 mt-2">
                    ...
                    <div class="grid grid-cols-12 gap-4 row form-row" v-show="promo.auto_apply == true || promo.auto_apply == 'true'">
                      <div class="col-span-3 mt-2">
              ...
              <div class="grid grid-cols-12 gap-4 row form-row">
                ...
                <div class="col-span-9">
                  <div class="input-group cursor-pointer" @click="$refs.file.click()">
                    <input class="form-control" v-model="promo.image">
