                  ...
                  <table class="table table-bordered table-striped fixed_header">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-right total font-weight-bold">{{currencyFormat(total_prepay_amount)}}</td>
              ...
              <!--<div class="grid grid-cols-12 gap-4">-->
                ...
                <!--<div class="col-span-8 text-right">-->
                  <!--<download-excel-->
                    ...
                    <!--worksheet = "Báo Cáo Theo Dv"-->
                    <!--name    = "bao_cao_theo_mon.xls">-->
                    <!--<b>Xuất Excel</b>-->
                  <!--</download-excel>-->
                <!--</div>-->
              <!--</div>-->
