    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-full">
        <div class="bg-white rounded-lg shadow-md p-4">
          ...
          <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12">
              <h4 class="mt-2 text-center text-header">Thiết lập thành viên</h4>
            </div>
          </div>
          <hr>
          <!-- Loading -->
          ...
          <div class="form-group">
            ...
            <div class="invalid-feedback invalid-feedback" :state="!errorDiscountByMoney">
              Vui lòng chọn một tùy chọn
            </div>
          </div>

          <div class="grid grid-cols-12 gap-4" v-show="setting.discountByMoney.value == 'true'">
            <div class="col-span-6">
              ...
              <div class="grid grid-cols-12 gap-4 text-center mt-2">
                <div class="col-span-full">
                  <button class="btn px-4 default-btn-bg btn-width-120" @click="addListDiscount()" :disabled="saving">
                    Thêm
                  </button>
                </div>
              </div>
