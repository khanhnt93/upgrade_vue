<template>
  <div class="container-fluid px-4 py-6">
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <!-- Title -->
      <h4 class="text-2xl font-semibold text-center text-blue-600 mb-4">Danh Sách Khoản Cho Vay</h4>
      <hr class="mb-6">
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <download-excel
          ...
          :data="excel_items"
          :fields="excel_fields"
          worksheet="Danh sách khoản cho vay"
          name="Danh sách khoản cho vay"
        >
          <b>Xuất Excel</b>
        </download-excel>
      </div>
