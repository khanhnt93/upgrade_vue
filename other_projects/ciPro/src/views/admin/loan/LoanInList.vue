<template>
  <div class="w-full px-4 py-6">
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <!-- Title -->
      <h4 class="text-2xl font-semibold text-center text-orange-600 mb-4">Danh Sách Khoản Đi Vay</h4>
      <hr class="mb-6">
...
const exportExcel = () => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, 'Danh sách khoản đi vay')
  XLSX.writeFile(wb, 'Danh sách khoản đi vay.xls', { bookType: 'xls' })
}
