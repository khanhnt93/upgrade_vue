    ...
    <b-row>
      <b-col>
        <b-card>
          <b-row>
            <b-col>
              <b-button variant="outline-success" class="pull-right btn-width-160 ml-2 mt-1" @click="goToAddInput">
                Thêm phiếu nhập
              </b-button>
              <b-button variant="outline-primary" class="pull-right btn-width-160 mt-1" @click="goToAddOutput">
                Thêm phiếu xuất
              </b-button>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col md='12'>
              <h4 class="mt-1 text-center text-header">Lịch Sử Xuất-Nhập Kho</h4>
            </b-col>
          </b-row>
          <hr>
                ...
                <tr v-for="(item) in items">
                  ...
                  <td class="text-center">
                    ...
                    <b-button v-show="!creatingPHG" v-if="item.type == 1 && item.order_sell_id"
                              variant="outline-success" class="text-center btn-width-160"
...
export default {
  ...
  data () {
    return {
      ...
      btn_input_text: "Thêm phiếu nhập",
      btn_output_text: "Thêm phiếu xuất",
      timeOptions: [
        {"value": 1, "text": 'Ngày'},
        {"value": 2, "text": 'Tháng'},
        {"value": 3, "text": 'Quý'},
   ...
   */
    ...
    goToAddOutput() {
      this.$router.push("/repo-output")
    },
    goToAddInput() {
      this.$router.push("/repo-input")
    },
