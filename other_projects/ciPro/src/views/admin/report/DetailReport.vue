<template>
  <div class="w-full mx-auto px-4">
    <div class="bg-white rounded-lg shadow p-6">
      <h4 class="text-xl font-semibold text-center text-orange-600 mb-4">Báo Cáo Doanh Thu - Lợi Nhuận Chi Tiết</h4>
      ...
      <div v-show="items.length > 0" class="mb-4">
        <p class="text-orange-600 font-semibold">Doanh thu: <b>{{currencyFormat(revenue_total)}}đ</b></p>
        <p class="text-orange-600 font-semibold">Lợi nhuận: <b>{{currencyFormat(profit_total)}}đ</b></p>
      </div>
