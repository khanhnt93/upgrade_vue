<template>
  <div class="container-fluid mx-auto p-4">
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <h4 class="text-xl font-bold text-center text-[#F85F36] mb-4">CẬP NHẬT THÔNG TIN ĐẶT PHÒNG {{booking.room_name}}</h4>
      <hr class="my-4">
    ...
    save() {
      ...
      adminAPI.editBooking(this.booking).then(res => {
        ...
        if(res != null && res.data != null) {
          ...
          this.toast.error('Cập nhật thông tin booking thất bại!!!')
        }
      }).catch(err => {
        this.saving = false
        let errorMess = commonFunc.handleStaffError(err)
