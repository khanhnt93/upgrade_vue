    ...
    <b-row>
      <b-col>
        <b-card>
          ...
          <b-row>
            <b-col md='12'>
              <h4 class="mt-1 text-center text-header">THÔNG TIN PHÒNG</h4>
            </b-col>
          </b-row>
          <hr>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleted (id, name) {
        if(id && name) {
          this.$bvModal.msgBoxConfirm('Xóa ' + name + ". Bạn có chắc không?", {
            ...
            if (res) {
              adminAPI.deleteRoomTypeInfo(id).then(res => {
       ...
       */
      edit (id) {
        this.$router.push('/room-type-info/edit/' + id)
      },
       ...
       */
      goToAdd () {
        this.$router.push('/room-type-info/add')
      },
      ...
      getRoomTypeInfo () {
        ...
        adminAPI.getRoomTypeInfo().then(res => {
          if(res != null && res.data != null && res.data.data != null) {
            this.items = res.data.data
          }
          this.onSearch = false
