  ...
  <div class="container-fluid mx-auto px-4">
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <div class="text-center mb-4">
        <h4 class="text-xl font-semibold mt-1 text-orange-500">TẦNG</h4>
      </div>
      <hr class="mb-4" />
  ...
  methods: {
    ...
    getFloorDetail() {
      ...
      if (id) {
        ...
        adminAPI.getFloorDetail(id).then(res => {
    ...
    save() {
      ...
      if (id) {
        // Edit
        this.inputs.id = id;
        adminAPI.editFloor(this.inputs).then(res => {
          this.saving = false;
        ...
        // Add
        adminAPI.addFloor(this.inputs).then(res => {
          this.saving = false;
          if (res != null && res.data != null) {
            if (res.data.status == 200) {
              this.router.push('/floor/list');
            }
          }
        }).catch(err => {
          this.saving = false;
